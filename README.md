...
| [redundant-type-conversion](docs/rules/redundant-type-conversion.md) | TRI006    | Flags a builtin type conversion that's a no-op given the argument's real type, including across files. Requires [`ty`](https://github.com/astral-sh/ty) on `PATH`. |
